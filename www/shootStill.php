...
//take still image with PiCamera and store it in '/var/www/html/share/www/img' directory
//edit the raspistill command here to taste but make sure not to remove the double quotes!
$output=shell_exec("/opt/vc/bin/raspistill -t 1000 -o /var/www/html/share/www/img/".$imgName.".jpg");
echo "Output=".$output;
